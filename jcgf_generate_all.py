...
# experiment settings
parser.add_argument('--experiments', type=str, default="L1")
parser.add_argument('--trials_from', type=int, default=1)
parser.add_argument('--trials_to', type=int, default=2)
parser.add_argument('--use_dask', type=bool, default=False)
parser.add_argument('--n_dask_workers', type=int, default=max(cpu_count() - 1, 1))
parser.add_argument('--random_seed', type=int, default=0)
parser.add_argument('--base_folder', type=str, default=".")
parser.add_argument('--experiment_name', type=str, default="local_debug")
parser.add_argument('--add_timestamp', type=bool, default=False)
parser.add_argument('--worker_number', type=int, default=1)
parser.add_argument('--draw_benchmark_data', type=bool, default=False)
parser.add_argument('--verbose', type=bool, default=True)

# problems settings
parser.add_argument('--num_covariates', type=int, default=19)
parser.add_argument('--correlation_between_adjacent_covariates', type=float, default=0.0)
parser.add_argument('--groups_sizes', type=tuple, default=(10, 15, 4, 8, 3, 5, 18, 9, 6))
parser.add_argument('--true_coefs_min', type=float, default=0)
parser.add_argument('--true_coefs_max', type=float, default=9.5)
parser.add_argument('--fit_fixed_intercept', type=bool, default=True)
parser.add_argument('--fit_random_intercept', type=bool, default=True)
parser.add_argument('--obs_var', type=float, default=0.3)
parser.add_argument('--distribution', type=str, choices=("normal", "uniform"), default="normal")

# models parameters
parser.add_argument('--elastic_eps', type=float, default=1e-7)
parser.add_argument('--initializer', type=str, default="None")
parser.add_argument('--logger_keys', type=tuple,
                    default=('converged', 'vaida_aic', 'jones_bic', 'muller_ic', 'vaida_aic_marginalized'))
parser.add_argument('--tol_oracle', type=float, default=1e-5)
parser.add_argument('--tol_solver', type=float, default=1e-4)
parser.add_argument('--take_only_positive_part', type=float, default=True)
parser.add_argument('--take_expected_value', type=float, default=False)
parser.add_argument('--max_iter_oracle', type=int, default=1000)
parser.add_argument('--max_iter_solver_pgd', type=int, default=300000)
parser.add_argument('--max_iter_solver_sr3', type=int, default=10000)
parser.add_argument('--fixed_step_size', type=float, default=1e-4)
parser.add_argument('--eta_min', type=int, default=-2)
parser.add_argument('--eta_max', type=int, default=1)
parser.add_argument('--eta_num_evals', type=int, default=10)
parser.add_argument('--information_criterion_for_model_selection', type=str, default='jones')
